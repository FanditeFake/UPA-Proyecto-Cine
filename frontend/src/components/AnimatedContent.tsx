...
const AnimatedContent = ({
  ...
  useEffect(() => {
    ...
    let scrollerTarget: string | HTMLElement | null = container ?? document.getElementById("snap-main-container");
    ...
    container, distance, direction, reverse, duration, ease, initialOpacity, animateOpacity,
    scale, threshold, delay, disappearAfter, disappearDuration, disappearEase, onComplete, onDisappearanceComplete,
  ]);
